...
function getCities(query) {
  return fetch(API_URL + '/cities/?search=' + query + '&embed=city:search-results/city:item/city:country&embed=city:search-results/city:item/city:admin1_division').then(function (res) {
    return res.json();
  }).then(function (json) {
...
var _ractiveRactiveRuntime = require('ractive/ractive.runtime');
 ...
 */
var Autocomplete = _ractiveRactiveRuntime2['default'].extend({
  ...
  data: function data() {
    return {
      ...
      wrapMatches: function wrapMatches() {
        var str = arguments.length <= 0 || arguments[0] === undefined ? '' : arguments[0];

        var res = str;
        this.get('query').split(/[\,\s]+/).forEach(function (q) {
      ...
      displayedKey: function displayedKey(item) {
  ...
  handleKeys: function handleKeys() {
    ...
    switch (code) {
      ...
      case Key.TAB:
        ...
        break;
      case Key.UP:
        this.set('activeItem', Math.max(0, i - 1));
        break;
      case Key.DOWN:
        this.set('activeItem', Math.min(list.length - 1, i + 1));
        break;
    }
  },
...
},{"./lib/parser":7,"./lib/resource":8}],6:[function(require,module,exports){
'use strict';
...
},{"./immutable_stack":6,"./resource":8}],8:[function(require,module,exports){
'use strict';
...
//# sourceMappingURL=teleport-autocomplete.bundled.js.map